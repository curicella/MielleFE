...
const PhotoUpload = () => {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const albumResponse = await fetch('http://miellebe-001-site1.ftempurl.com/api/Albums/createAlbum', {
        method: 'POST',
        headers: {
      ...
      const photoUploadResponse = await fetch(`http://miellebe-001-site1.ftempurl.com/api/Albums/uploadPhotos?albumId=${albumId}&employeeId=${loggedInEmployeeId}`, {
        method: 'POST',
        body: formData,
      });

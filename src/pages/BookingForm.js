...
const BookingForm = () => {
    ...
    const handleNextStep = async (e) => {
        ...
        if (currentStep === 1) {
            try {
                const response = await fetch('http://miellephotostudiobe.somee.com/api/Bookings/CheckAvailability', {
                    method: 'POST',
                    headers: {
    ...
    const handleSubmit = async (e) => {
        ...
        if (parseFloat(paymentAmount) === price) {
            try {
                const bookingResponse = await fetch('http://miellephotostudiobe.somee.com/api/Bookings/Create', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
                ...
                const confirmResponse = await fetch('http://miellephotostudiobe.somee.com/api/Bookings/Confirm', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
